...
- `src/grok/` - C code for lexer (flex) and parser (bison)
...
- `src/configuration.zig` - Configuration handling
- `patterns/` - Pattern definitions
- `build.zig` - Build configuration (uses flex, bison, pcre2, yazap, glob)
