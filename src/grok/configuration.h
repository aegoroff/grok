...
typedef struct configuration_ctx_t {
    void (*on_string)(struct arg_file* files, const char* const macro, const char* const str, int info_mode);
    void (*on_file)(struct arg_file* files, const char* const macro, const char* const path, int info_mode);
    int argc;
