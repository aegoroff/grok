...
#define OPT_PATT_DESCR                                                                                                 \
    "one or more pattern files. You can also use wildcards like path\\*.patterns. If not set, current directory used " \
    "to search all *.patterns files"
...
#define OPT_FILE_DESCR                                                                                                 \
    "full path to file to read data from. If not set and string option not set too data read from stdin"
...
void prconf_print_copyright(void) { lib_printf(COPYRIGHT_FMT, APP_NAME); }
